...
}var acorn = /*#__PURE__*/Object.freeze({Node: Node$1,Parser: Parser,Position: Position,SourceLocation: SourceLocation,TokContext: TokContext,Token: Token,TokenType: TokenType,defaultOptions: defaultOptions,getLineInfo: getLineInfo,isIdentifierChar: isIdentifierChar,isIdentifierStart: isIdentifierStart,isNewLine: isNewLine,keywordTypes: keywords$1,lineBreak: lineBreak,lineBreakG: lineBreakG,nonASCIIwhitespace: nonASCIIwhitespace,parse: parse,parseExpressionAt: parseExpressionAt,tokContexts: types$1,tokTypes: types,tokenizer: tokenizer,version: version});function getCjsExportFromNamespace (n) {
	return n && n['default'] || n;
}var acorn$1 = getCjsExportFromNamespace(acorn);const tt = acorn$1.tokTypes;
...
marked.parse = marked;const HL_ROOT =
...
define.amd = {};function requirer(resolve) {
...
RuntimeError.prototype.constructor = RuntimeError;function generatorish(value) {
  return value
...
var forEach = prototype.forEach;function constant$1(x) {
  return function() {
    return x;
  };
}function identity(x) {
...
}function noop$1() {}var TYPE_NORMAL = 1; // a normal variable
    ...
    import {${specifiers.map(
      specifier => `${specifier.name} as ${specifier.alias}`
        ...
        if (cell.id && cell.id.type === "ViewExpression") {
          ...
          main.variable(null).define(cellName, [reference], Generators$1.input);
        } else {
          main
